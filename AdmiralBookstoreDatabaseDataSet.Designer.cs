...
namespace LabTest2 {
    ...
    public partial class AdmiralBookstoreDatabaseDataSet : global::System.Data.DataSet {
        ...
        public partial class StockDataTable : global::System.Data.TypedTableBase<StockRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public StockRow AddStockRow(int StockID, int AuthorID, string ISBN_13, int QuantityInStock, System.DateTime DateRecorded) {
        ...
        public partial class StockRow : global::System.Data.DataRow {
            ...
            public string ISBN_13 {
                get {
                    return ((string)(this[this.tableStock.ISBN_13Column]));
                }
                set {
                    this[this.tableStock.ISBN_13Column] = value;
                }
            }
...
namespace LabTest2.AdmiralBookstoreDatabaseDataSetTableAdapters {
    ...
    public partial class StockTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Stock] WHERE (([StockID] = @Original_StockID) AND ([AuthorID] " +
                "= @Original_AuthorID) AND ([ISBN_13] = @Original_ISBN_13) AND ([QuantityInStock]" +
                " = @Original_QuantityInStock) AND ([DateRecorded] = @Original_DateRecorded))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Stock] ([StockID], [AuthorID], [ISBN_13], [QuantityInStock], [DateRecorded]) VALUES (@StockID, @AuthorID, @ISBN_13, @QuantityInStock, @DateRecorded);
SELECT StockID, AuthorID, ISBN_13, QuantityInStock, DateRecorded FROM Stock WHERE (StockID = @StockID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Stock] SET [StockID] = @StockID, [AuthorID] = @AuthorID, [ISBN_13] = @ISBN_13, [QuantityInStock] = @QuantityInStock, [DateRecorded] = @DateRecorded WHERE (([StockID] = @Original_StockID) AND ([AuthorID] = @Original_AuthorID) AND ([ISBN_13] = @Original_ISBN_13) AND ([QuantityInStock] = @Original_QuantityInStock) AND ([DateRecorded] = @Original_DateRecorded));
SELECT StockID, AuthorID, ISBN_13, QuantityInStock, DateRecorded FROM Stock WHERE (StockID = @StockID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT StockID, AuthorID, ISBN_13, QuantityInStock, DateRecorded FROM dbo.Stock";
        ...
        public virtual int Delete(int Original_StockID, int Original_AuthorID, string Original_ISBN_13, int Original_QuantityInStock, System.DateTime Original_DateRecorded) {
            ...
            if ((Original_ISBN_13 == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[2].Value = ((string)(Original_ISBN_13));
            }
        ...
        public virtual int Insert(int StockID, int AuthorID, string ISBN_13, int QuantityInStock, System.DateTime DateRecorded) {
            ...
            if ((ISBN_13 == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[2].Value = ((string)(ISBN_13));
            }
        ...
        public virtual int Update(int StockID, int AuthorID, string ISBN_13, int QuantityInStock, System.DateTime DateRecorded, int Original_StockID, int Original_AuthorID, string Original_ISBN_13, int Original_QuantityInStock, System.DateTime Original_DateRecorded) {
            ...
            if ((ISBN_13 == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(ISBN_13));
            }
            ...
            if ((Original_ISBN_13 == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((string)(Original_ISBN_13));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int AuthorID, string ISBN_13, int QuantityInStock, System.DateTime DateRecorded, int Original_StockID, int Original_AuthorID, string Original_ISBN_13, int Original_QuantityInStock, System.DateTime Original_DateRecorded) {
            return this.Update(Original_StockID, AuthorID, ISBN_13, QuantityInStock, DateRecorded, Original_StockID, Original_AuthorID, Original_ISBN_13, Original_QuantityInStock, Original_DateRecorded);
        }
    }
